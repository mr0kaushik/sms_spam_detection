...
class UndecidableScreen extends StatelessWidget {
  @override
...
List<Message> chats = [
  new Message(
    isRead: true,
    sender:
        new User(id: 0, name: 'Deepak', imageUrl: 'asset/images/deadpool.jpg'),
    time: "12:20 pm",
  ...
  new Message(
    isRead: true,
    sender:
        new User(id: 1, name: 'Harshit', imageUrl: 'asset/images/deadpool.jpg'),
    time: "12:20 pm",
    text: "Thanks buddy, see you soon",
    isSent: true,
  ),
  ...
  new Message(
    isRead: false,
    sender:
        new User(id: 7, name: 'Anjali', imageUrl: 'asset/images/deadpool.jpg'),
    time: "12:20 pm",
